...
urlpatterns = [
    ...
    path('test_plan/<int:pk>/update', views.TestPlanUpdateView.as_view(), name='update_test_plan'),
    path('test_plan/<int:pk>/read', views.TestPlanReadView.as_view(), name='read_test_plan'),
    path('test_plan/<int:pk>/delete', views.TestPlanDeleteView.as_view(), name='delete_test_plan')
]
